...
Sound.prototype.play = function(focusType,onEnd) {  //Parameter "focusType" is added by Chandrajyoti
  if (this._loaded) {
    RNSound.play(this._key, focusType, (successfully) => onEnd && onEnd(successfully));
  } else {
    onEnd && onEnd(false);
  }
  return this;
